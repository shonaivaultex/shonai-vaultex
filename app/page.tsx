...
const features = [
  { icon: Trophy, title: "START WITH YOU.", text: "初めにカウンセリングを行い、好きなこと、挑戦したいこと、性格や傾向を理解するところから始めます。不安や生活のスケジュールも聞きながら、その人に合ったプランを一緒に考えます。" },
  { icon: Users, title: "GROW TOGETHER.", text: "人数や練習内容に合わせて、ウォーミングアップにレクリエーションを取り入れます。準備や片付け、計測、動画撮影もできることを分担。自分のペースを大切にしながら、お互いを応援できる関係を育てます。" },
  { icon: Dumbbell, title: "KNOW WHY.", text: "私自身の競技経験に加え、測定データ、動作分析、論文などの研究知見から競技力の向上を支えます。練習の根拠と、まだ確かではないことも分けて伝え、選手が納得して取り組める指導を大切にします。" },
] as const;
