...
export default function CalendarSyncButton() {
  ...
  return <>
    <button type="button" onClick={() => void prepare()} className="inline-flex items-center gap-2 rounded-xl border border-sky-400/35 bg-sky-400/[.07] px-4 py-3 text-sm font-black text-sky-300"><CalendarPlus size={17}/>iPhoneカレンダーと同期</button>
