...
export default function MyCalendar({ userId, initialEntries, schedules, activeScheduleIds, records, periods, initialGoal, goalHistory, initialSelectedDate }: { userId: string; initialEntries: Entry[]; schedules: ClubSchedule[]; activeScheduleIds: number[]; records: PerformanceRecord[]; periods: SchedulePeriod[]; initialGoal: CalendarGoal | null; goalHistory: CalendarGoal[]; initialSelectedDate?: string }) {
