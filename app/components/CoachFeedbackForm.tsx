...
export default function CoachFeedbackForm({ recordId, requestId }: { recordId: number; requestId?: number | null }) {
  ...
  return <form onSubmit={submit} className="mt-4 rounded-xl border border-orange-500/25 bg-orange-500/[0.05] p-4">
    <label className="flex items-center gap-2 text-xs font-black tracking-[0.1em] text-orange-300"><MessageSquare size={15} />{requestId ? "依頼に回答する" : "フィードバック"}</label>
