...
export const programs: Program[] = [
  {
    ...
    highlights: [
      ...
      { title: "KEEP YOUR PROGRESS", description: "記録や動画、振り返りを残し、自分の変化を見つけます。結果だけでなく、挑戦したことや工夫したことも一緒に振り返ります。" },
      { title: "TEAM SPIRIT", description: "同じ種目に取り組む時間や、準備・片付け、計測・動画撮影を通して、お互いを応援できる関係を育てます。できることを分担し、少しずつなじめる環境を大切にします。" },
    ],
    flow: [
      { time: "01", title: "WARM UP", description: "その日の状態を確認し、人数や練習内容に合わせて遊びやレクリエーションも取り入れながら、心とからだをほぐします。" },
  ...
  },
  {
    ...
    highlights: [
      { title: "KNOW WHY", description: "なぜこの練習をするのか、どんな変化を目指すのかを伝えます。データや動きを一緒に確認し、根拠と、まだ確かではないことを分けて説明します。" },
      { title: "CONDITIONING", description: "成長段階や体調、学校での練習量に合わせて負荷を調整します。無理に周囲へ合わせるのではなく、自分に合ったペースで取り組みます。" },
    ...
    flow: [
      ...
      { time: "04", title: "REVIEW", description: "記録や動画をコーチと振り返ります。否定する言葉ではなく、次にできる工夫を一緒に考え、試合に向けた準備にもつなげます。" },
    ],
    faq: [
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: "INSIGHT TO ACTION", description: "測定や動画から課題を整理し、研究知見も参考にしながら改善を試します。数値だけで決めつけず、本人の感覚と照らし合わせて振り返ります。" },
      { title: "READY TO COMPETE", description: "試合までの練習や当日の準備を一緒に考え、不安を少しずつ減らします。否定するのではなく、次につながる言葉で技術と気持ちの両面を支えます。" },
    ],
    flow: [
      ...
      { time: "03", title: "EXECUTE", description: "目標とその日の状態に合った専門練習に取り組みます。必要に応じて計測や動画撮影を行い、動きと感覚を確認します。" },
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: "KEEP CHALLENGING", description: "周囲のペースに無理に合わせる必要はありません。同じ練習や準備・片付けを通して、自然に関われる時間を大切にします。" },
    ],
    flow: [
      ...
      { time: "04", title: "CONNECT", description: "その日の感覚や記録を振り返り、次に取り組みたいことを考えます。一緒に練習した人とも、無理のない範囲で振り返りを共有します。" },
    ],
    faq: [
