...
export const programs: Program[] = [
  {
    ...
    description: "初めにカウンセリングで、お子さまの好きなことや性格、挑戦したいことを伺います。走る・跳ぶ・投げるなど、さまざまな体験から自分に合う競技を探し、自分のペースで取り組みます。「自分も小学生の頃からデータを残しておきたかった」という代表コーチの思いから、記録や動画を通して長い時間をかけた成長を残すことも大切にしています。",
  ...
  },
  {
    ...
    description: "さらに競技力を高めたい方へ。カウンセリングで目標や課題、生活のスケジュールを伺い、選手自身の考えを軸に練習方針を組み立てます。コーチ陣の競技・指導経験に加え、測定データ、動作分析、論文などの研究知見をさまざまな角度から検討し、取り組みの根拠を共有します。ELITEという名称は競技レベルの上下や昇格を意味しません。",
    price: "月額 5,000円", priceNote: "基本会費",
    highlights: [
