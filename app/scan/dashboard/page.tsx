...
export default async function ScanDashboard(){
 ...
 return <main className="px-5 pb-24 pt-28 sm:px-8"><div className="mx-auto max-w-6xl"><Link href="/scan" className="inline-flex items-center gap-2 text-xs font-bold text-white/45 hover:text-orange-400"><ArrowLeft size={15}/>CONTROL TEST</Link><p className="mt-9 text-xs font-black tracking-[.2em] text-emerald-400">TEAM CONSOLE</p><h1 className="mt-2 text-4xl font-black sm:text-6xl">チーム管理</h1><ScanDashboardClient teams={teams}/></div></main>;
}
